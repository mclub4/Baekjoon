...
- 개발, CS관련은 개인적인 공부에 초점을 맞춰져 있어서 원하는 내용이 없을 수도 있음.
...
- ☢️기초적인 것 부터 대회용 어려운 알고리즘까지 존재하는 거의 모든 알고리즘 다 있으니 왠만하면 플래티넘부턴 알잘딱으로 거를 것. 개발/CS/시사이슈 관련해서는 맨 밑에 10장에 따로 모아뒀음☢️
